...
[assembly: ExportRenderer(typeof(CommonEntry), typeof(IOSCommonEntryRenderer))]
namespace MapNotePad.iOS.Renderers
{
    public class IOSCommonEntryRenderer : EntryRenderer
    {
        ...
        {
            if (e.PropertyName == CommonEntry.PaddingProperty.PropertyName)
            {
                UpdatePadding();
            }
